...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_prediksi) {
            // Handle the camera action
            fm.beginTransaction().replace(R.id.content_frame, new PrediksiFragment()).commit();
        } else if (id == R.id.nav_input_data) {
            fm.beginTransaction().replace(R.id.content_frame, new InputDataFragment()).commit();

        } else if (id == R.id.nav_lihat_data) {
            fm.beginTransaction().replace(R.id.content_frame, new LihatDataFragment()).commit();
